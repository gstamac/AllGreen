...
namespace AllGreen.VS2013Integration_UnitTests.MyToolWindowTest
{
    ...
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new AllGreen_VS2013IntegrationPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(AllGreen_VS2013IntegrationPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
